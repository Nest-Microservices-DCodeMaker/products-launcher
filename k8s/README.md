...
kubectl create deployment <nombre> --image=<registro/url/imagen> --dry-run=client -o yaml | Out-File ./deployment.yml -Encoding UTF8
```

# Crear service
```
kubectl create service clusterip <nombre> --tcp=<8888> --dry-run=client -o yaml | Out-File ./service.yml -Encoding UTF
kubectl create service nodeport <nombre> --tcp=<3000> --dry-run=client -o yaml | Out-File ./service.yml -Encoding UTF
```
